<?php
//Clase de conexion estandares de control de la crud 
...
class Database  extends PDO
{
  ...
  //sobre Carga constructor con la caden ad econexion a la vase de datos	
...
//metodos de la clase para hacer una crud en todas las tablas 
